...
function getTemplate(obj){return request('get','../templates/'+obj.template,true).then(response => {obj.template=response;return Promise.resolve(obj);}).catch(err => {return Promise.reject(err);});} //pars the template with the data given by the controller
